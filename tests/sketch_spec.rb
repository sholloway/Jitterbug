...
describe Jitterbug::Layers::Sketch do
	...
	describe "new layer" do
		it "should create a new layer with provided name" do 
			lm = Sketch.new(@engine,{:working_dir => @full_dir,:logger=>@logger, :render_logger=>@logger})
	...
	describe "sketch.yml i/o" do
		...
		it "should load the layer data from layer.yml" do
			...
			lm2 = Sketch.new(@engine,{:working_dir => @full_dir,:logger=>@logger, :render_logger=>@logger})
			lm2.load
